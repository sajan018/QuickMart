          ...
          <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="text-center">
              ...
              <div class="px-8 sm:items-start sm:justify-center sm:px-0 sm:space-x-5 sm:flex mt-9">
                <a href="mailto:s07sajan@gmai.com?subject=Instructions&body=1.%20Send%20Request%20with%20the%20same%20reigistered%20Email%20ID.%20%0A2.%20Send%20some%20description%20about%20your%20shop%20and%20your%20products.">
          ...
          {/* <div class="bg-white">
            <div class="relative mx-auto mt-4 md:mt-8">
              <div class="lg:max-w-4xl lg:mx-auto">
                <img class="px-4 md:mpx-8" src="images/15.png" />
              </div>
            </div>
          </div> */}
        </section>
                    ...
                    <div className="h-100 shadow-sm rounded-xl bg-sky-50 bg-opacity-40">
                      ...
                      <div className="d-flex gap-2 px-2 py-2 flex-column justify-content-between">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            className="px-4 py-2 w-11 border-1 border-yellow-500 hover:bg-yellow-400 rounded-lg"
                            onClick={() =>
                              addToCart(
                                p,
                                p.quantity,
